...
export function AreaResultTable({finalresulst}:{finalresulst:FinalResults}) {
    const {max, media, min, avg5, solves} = finalresulst;
  return (
    <div className="area_table area_table_results">
        <button>X</button>
